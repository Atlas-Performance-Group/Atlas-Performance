    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          <a href={`/api/rastreador/ips/${encodeURIComponent(ip)}/report`} className="atlas-btn-primary">
            Gerar relatório
          </a>
          <Link href="/admin/rastreador" className="atlas-btn-secondary" style={{ color: "var(--ink)" }}>
            Voltar
          </Link>
        </div>
      </div>
