...
const TYPE_LABELS: Record<AuditLogType, string> = {
  ...
  csv_imported: "CSV importado",
  metrics_reset: "Dados zerados",
...
const TYPE_COLORS: Record<AuditLogType, string> = {
  ...
  client_created: "#2fa64c",
  csv_imported: "var(--gold-500)",
  metrics_reset: "var(--red-600)",
  link_created: "#2fa64c",
  link_updated: "var(--gold-500)",
  ...
  return (
    <div className="atlas-card p-6">
      ...
      <p className="text-xs mb-4" style={{ color: "var(--ink-faint)" }}>
        Logins, tentativas de acesso, importações de CSV, criação/edição de clientes e links. Atualiza a
        cada {POLL_INTERVAL_MS / 1000}s automaticamente.
      </p>
